<?php
  /*==========================================================================+
   ...
   +--------------------------------------------------------------------------+
   | Script-ID      : header22.php                                            |
   | DATA-WRITTEN   : 2002.07.15                                              |
   | AUTHER         : N.WATANUKI                                              |
   | UPDATE-WRITTEN : 2015.01.26 Naoshi Watanuki.                             |
   +==========================================================================*/
/* [ Initial Setup. ] */
    $crrentdate = getdate();
...
//    print("<div id='date' style='position:absolute; top:22px; left:124px; font-size:13px; color:#0099FF'>$wdate</div> \n");
    if($wday == 0) { /* Sunday will TEXT Color Red. */
        print("<div id='date' style='position:absolute; top:22px; left:195px; font-size:13px; color:#FF0000'>$wdeAry[$wday]</div> \n");
    } else {
        print("<div id='date' style='position:absolute; top:22px; left:195px; font-size:13px; color:#0099FF'>$wdeAry[$wday]</div> \n");
    }
